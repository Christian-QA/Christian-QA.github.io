    ...
    resources: {
        en: {
            translation: {
                ...
                "about.subtitle": "Heyo, welcome to my portfolio website!",
                "about.tagline": "I create user-friendly and reusable APIs and web components that empower businesses of all sizes.",
